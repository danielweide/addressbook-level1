...
public class AddressBook {
    ...
    private static String executeCommand(String userInputString) {
        ...
        case COMMAND_FIND_WORD:
            return executeFindPersons(commandArgs); // The Search
    ...
    private static String executeFindPersons(String commandArgs) {
        final Set<String> keywords = extractKeywordsFromFindPersonArgs(commandArgs); // The Change
           ...
           /* for(String wordsInNames: wordsInName) 
            {
            	for(String keyword : keywords) 
            	{
            		if(wordsInNames.contains(keyword)) {
            			matchedPersons.add(person);
            		}else if(getEmailFromPerson(person).contains(keyword)&&!matchedPersons.contains(person)) 
            		{
            			matchedPersons.add(person);
            		}
            	}
